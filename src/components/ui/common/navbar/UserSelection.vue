...
watch(
  ...
  (newVal) => {
    ...
    if (newVal.fields.appointments) {
      getUpcomingAppointmentsByIds(newVal.fields.appointments).then(
        (appointments: AllAppointmentsResponseModel) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <avatar
                  :user-surname="person.fields.agent_surname"
                  :user-name="person.fields.agent_name"
                  :user-color="person.fields.color"
                />
                <span
                  :class="[
