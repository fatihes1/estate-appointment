...
<template>
  <div
    class="flex flex-col gap-y-3 md:gap-y-0 md:flex-row items-center bg-indigo-500 py-2 px-3 justify-start rounded-md w-full"
  >
    <div
      v-if="status === 'Upcoming'"
      class="flex flex-col md:flex-row rounded-lg bg-white w-6/12 py-2 items-center justify-around h-full text-sm"
    >
    ...
    <div
      v-else
      class="flex rounded-lg bg-white w-6/12 py-2 items-center justify-center h-full text-red-500 text-sm"
    >
    ...
    <div
      class="flex flex-row justify-center items-center text-white text-sm w-4/12"
    >
