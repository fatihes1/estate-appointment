...
<template>
  <div class="flex flex-row items-center bg-indigo-500 py-2 px-3 justify-start rounded-md w-full">
    <div v-if="status === 'Upcoming'" class="flex rounded-lg bg-white w-6/12 py-2 items-center justify-around h-full text-sm">
