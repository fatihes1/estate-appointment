...
<template>
  <div class="py-5 border-b-2 border-gray-200 ">
    ...
    <div v-else>
      <div class="flex flex-col md:flex-row gap-y-3 md:gap-y-0 justify-between items-center">
        <div class="text-md font-bold" v-if="appointmentStore.filteredAppointments">
